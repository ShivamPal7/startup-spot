...
const StartupForm = () => {
    ...
    return <form action={formAction} className="startup-form">
        ...
        <div>
            ...
            <Input id="category" name="category" className="startup-form_input" required placeholder="Startup Category (e.g. Tech, Health, Ai)" />
        ...
        <div data-color-mode="light">
            ...
            <MDEditor
                ...
                preview="edit"
                height={300}
                style={{ borderRadius: 20, border: "3px solid black", overflow: "hidden" }}
                textareaProps={{
